...
# -------------------------
# Simple Product Catalog (Fahad Shop)
# -------------------------
...
# -------------------------
# The Agent (Peter Parker)
# -------------------------
class GameMasterAgent(Agent):
    def __init__(self):
        # System instructions now describe the shopkeeper persona and commerce role
        instructions = """
        You are 'Peter Parker', the friendly shopkeeper and voice assistant for Md Fahad Shop.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🛍️" * 6)
    logger.info("🚀 STARTING VOICE E-COMMERCE AGENT (Md Fahad Shop) — Peter Parker")
    ...
    # Start the agent session with the GameMasterAgent (Peter Parker)
    await session.start(
